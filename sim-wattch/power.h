...
static double FSF = 1.0;//CS203A

/*VSF- voltage scaling factor */
static double VSF = 1.0;//CS203A

/* power factor with voltage scaling factor & frequency scaling factor*/
...
/*DVFS controller function*/
void dvfs_controller();//CS203A

/*DVFS Interval - number of cycles (N) once DVFS power is checked.*/
int dvfs_interval;//CS203A

/* DVFSTargetPower: - target power to be achieved*/
double dvfs_target_power;//CS203A
////////////////////////////////////////////////////
